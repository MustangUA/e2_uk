...
function e2l_load_strings () {
  ...
  'ff--just-connect' => 'Дані в моїй базі вже є, потрібно просто підключитись до неї',
  ...
  'gs--you-are-not-subscribed' => 'Здається, ви так і не підписані на коментарі до цього допису',
  ...
  'gs--comment-spam-suspect-description' => 'Вибачте, але роботи вирішив, що це спам, тому коментар не відправлено.',
  ...
  'er--bad-tag-urlname' => 'Такий вигляд не може використовуватись в адресному рядку',
  ...
  'gs--search-query-empty' => 'Текст для пошуку порожній, напишіть щось',
  ...
  'gs--np-action-note-edit' => 'змінити допис',
  'gs--np-action-comment-edit' => 'змінити цей коментар',
  ...
  'gs--np-action-tag-edit' => 'змінити цей тег',
  'gs--np-action-name-and-author' => 'змінити назву блогу',
  ...
  'gs--e2-autodetects-timezone' => 'При публікації часовий пояс зазвичай визначається автоматично. Якщо не вийде, використовується пояс, обраний тут.',
  ...
  'em--created-automatically' => 'Лист створений автоматично.',
  ...
  'er--cannot-connect-to-db' => 'Не можу з’єднатись з базою даних',
